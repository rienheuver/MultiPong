...
!function (a) {
  ...
  return function a(b, c, d) {
    ...
    3: [function (a, b, c) {
      ...
      d.prototype.canSee = function (a, b) {
        ...
        for (var x = 0; x < this.vertices.length; ++x)if (v.isReflex(x)) {
          ...
          if (r == (q + 1) % this.vertices.length)l[0] = (k[0] + j[0]) / 2, l[1] = (k[1] + j[1]) / 2, c.push(l), q > x ? (t.append(v, x, q + 1), t.vertices.push(l), u.vertices.push(l), 0 != r && u.append(v, r, v.vertices.length), u.append(v, 0, x + 1)) : (0 != x && t.append(v, x, v.vertices.length), t.append(v, 0, q + 1), t.vertices.push(l), u.vertices.push(l), u.append(v, r, x + 1)); else {
    ...
    19: [function (a, b, c) {
      ...
      d.prototype = new e, d.prototype.constructor = d, d.prototype.setLimits = function (a, b) {
        ...
        if (this.upperLimitEnabled && q > h)o.angle = h, -1 === e.indexOf(o) && e.push(o); else {
          var r = e.indexOf(o);
          -1 !== r && e.splice(r, 1)
        }
    ...
    26: [function (a, b, c) {
      ...
      b.exports = d, d.prototype = {
        constructor: d, on: function (a, b, c) {
    ...
    39: [function (a, b, c) {
      ...
      d.prototype.raycast = function (a, b, c, d) {
        ...
        if (!(0 > n))if (0 === n)f.lerp(o, e, i, n), f.sub(p, o, c), f.normalize(p, p), b.reportIntersection(a, n, p, -1); else {
    ...
    61: [function (a, b, c) {
      function d(a) {
        ...
        }, this.overlappingShapesLastState = {keys: []}, this.overlappingShapesCurrentState = {keys: []}, this.overlapKeeper = new t
      }
  ...
  return b.game = null, b.WEBGL_RENDERER = 0, b.CANVAS_RENDERER = 1, b.VERSION = "v2.2.9", b._UID = 0, "undefined" != typeof Float32Array ? (b.Float32Array = Float32Array, b.Uint16Array = Uint16Array, b.Uint32Array = Uint32Array, b.ArrayBuffer = ArrayBuffer) : (b.Float32Array = Array, b.Uint16Array = Array), b.PI_2 = 2 * Math.PI, b.RAD_TO_DEG = 180 / Math.PI, b.DEG_TO_RAD = Math.PI / 180, b.RETINA_PREFIX = "@2x", b.DisplayObject = function () {
    ...
    if (!this.contextLost) {
      a.updateTransform();
      var b = this.gl;
      b.viewport(0, 0, this.width, this.height), b.bindFramebuffer(b.FRAMEBUFFER, null), this.game.clearBeforeRender && (b.clearColor(a._bgColor.r, a._bgColor.g, a._bgColor.b, a._bgColor.a), b.clear(b.COLOR_BUFFER_BIT)), this.renderDisplayObject(a, this.projection)
    }
    ...
    if (0 !== this.currentBatchSize) {
      ...
      for (var f, g, h, i, j = 0, k = 0, l = null, m = this.renderSession.blendModeManager.currentBlendMode, n = null, o = !1, p = !1, q = 0, r = this.currentBatchSize; r > q; q++) {
        if (i = this.sprites[q], f = i.tilingTexture ? i.tilingTexture.baseTexture : i.texture.baseTexture, g = i.blendMode, h = i.shader || this.defaultShader, o = m !== g, p = n !== h, (l !== f && !f.skipRender || o || p) && (this.renderBatch(l, j, k), k = q, j = 0, l = f, o && (m = g, this.renderSession.blendModeManager.setBlendMode(m)), p)) {
    ...
    if (this.width = a || 100, this.height = c || 100, this.resolution = f || 1, this.frame = new b.Rectangle(0, 0, this.width * this.resolution, this.height * this.resolution), this.crop = new b.Rectangle(0, 0, this.width * this.resolution, this.height * this.resolution), this.baseTexture = new b.BaseTexture, this.baseTexture.width = this.width * this.resolution, this.baseTexture.height = this.height * this.resolution, this.baseTexture._glTextures = [], this.baseTexture.resolution = this.resolution, this.baseTexture.scaleMode = e || b.scaleModes.DEFAULT, this.baseTexture.hasLoaded = !0,
        b.Texture.call(this, this.baseTexture, new b.Rectangle(0, 0, this.width * this.resolution, this.height * this.resolution)), this.renderer = d || b.defaultRenderer, this.renderer.type === b.WEBGL_RENDERER) {
    ...
    if (this.visible !== !1 && 0 !== this.alpha) {
      ...
      g.x %= this.tilingTexture.baseTexture.width, g.y %= this.tilingTexture.baseTexture.height, c.scale(h.x, h.y), c.translate(g.x + this.anchor.x * -this._width, g.y + this.anchor.y * -this._height), c.fillStyle = this.tilePattern;
      var i = -g.x, j = -g.y, k = this._width / h.x, l = this._height / h.y;
      a.roundPixels && (i |= 0, j |= 0, k |= 0, l |= 0), c.fillRect(i, j, k, l), c.scale(1 / h.x, 1 / h.y), c.translate(-g.x + this.anchor.x * this._width, -g.y + this.anchor.y * this._height), this._mask && a.maskManager.popMask(a);
    ...
    if (this.texture.baseTexture.hasLoaded) {
      var d = this.texture, e = d.frame, f = this._frame.sourceSizeW, g = this._frame.sourceSizeH, h = 0, i = 0;
  ...
  window.console || (window.console = {}, window.console.log = window.console.assert = function () {
    ...
    copyFrom: function (a) {
      ...
      return this.x = a || 0, this.y = b || (0 !== b ? this.x : 0),
        this
    }, set: function (a, b) {
    ...
    this.game = a, this.hitCanvas = null, this.hitContext = null, this.moveCallbacks = [], this.pollRate = 0, this.enabled = !0, this.multiInputOverride = c.Input.MOUSE_TOUCH_COMBINE, this.position = null, this.speed = null, this.circle = null, this.scale = null, this.maxPointers = -1, this.tapRate = 200, this.doubleTapRate = 300, this.holdRate = 2e3, this.justPressedRate = 200, this.justReleasedRate = 200, this.recordPointerHistory = !1, this.recordRate = 100, this.recordLimit = 100, this.pointer1 = null, this.pointer2 = null, this.pointer3 = null, this.pointer4 = null, this.pointer5 = null, this.pointer6 = null, this.pointer7 = null, this.pointer8 = null, this.pointer9 = null, this.pointer10 = null, this.pointers = [], this.activePointer = null, this.mousePointer = null, this.mouse = null, this.keyboard = null, this.touch = null, this.mspointer = null, this.gamepad = null, this.resetLocked = !1, this.onDown = null, this.onUp = null, this.onTap = null, this.onHold = null, this.minPriorityID = 0,
      this.interactiveItems = new c.ArraySet, this._localPoint = new c.Point, this._pollCounter = 0, this._oldPosition = null, this._x = 0, this._y = 0
    ...
    addCallbacks: function (a, b) {
      ...
      this._padParent.onDownCallback && this._padParent.onDownCallback.call(this._padParent.callbackContext, a, b, this.index), this.onDownCallback && this.onDownCallback.call(this.callbackContext, a, b), this._buttons[a] && this._buttons[a].start(null, b)
  ...
  c.Button.prototype.clearFrames = function () {
    ...
    move: function (a, b, c) {
      ...
      if ((void 0 === a || null === a) && (a = !1),
        (void 0 === b || null === b) && (b = !1), (void 0 === d || null === d) && (d = !1), a || b || d) {
        void 0 === e && (e = new c.Rectangle(0, 0, this.width, this.height));
    ...
    return e.baseTexture.resolution = a, d.context.scale(a, a), d.context.translate(-c.x, -c.y), PIXI.CanvasGraphics.renderGraphics(this, d.context), e
    ...
    for (d = c.lastIndex; d < a.graphicsData.length; d++) {
      ...
      if (g.type === PIXI.Graphics.POLY) {
        if (g.points = g.shape.points.slice(), g.shape.closed && (g.points[0] !== g.points[g.points.length - 2] || g.points[1] !== g.points[g.points.length - 1]) && g.points.push(g.points[0], g.points[1]), g.fill && g.points.length >= 6)if (g.points.length < 12) {
    ...
    if (i.push(d, e + h), i = i.concat(PIXI.WebGLGraphics.quadraticBezierCurve(d, e + g - h, d, e + g, d + h, e + g)), i = i.concat(PIXI.WebGLGraphics.quadraticBezierCurve(d + f - h, e + g, d + f, e + g, d + f, e + g - h)), i = i.concat(PIXI.WebGLGraphics.quadraticBezierCurve(d + f, e + h, d + f, e, d + f - h, e)), i = i.concat(PIXI.WebGLGraphics.quadraticBezierCurve(d + h, e, d, e, d, e + h)), a.fill) {
      var j = PIXI.hex2rgb(a.fillColor), k = a.fillAlpha, l = j[0] * k, m = j[1] * k, n = j[2] * k, o = b.points, p = b.indices, q = o.length / 6, r = PIXI.PolyK.Triangulate(i), s = 0;
    ...
    var c = a.points;
    if (!(c.length < 6)) {
      var d = b.points, e = b.indices, f = c.length / 2, g = PIXI.hex2rgb(a.fillColor), h = a.fillAlpha, i = g[0] * h, j = g[1] * h, k = g[2] * h, l = PIXI.PolyK.Triangulate(c);
      if (!l)return !1;
    ...
    void 0 === b && (b = 0), void 0 === d && (d = 0), this.type = c.GRAPHICS, this.physicsType = c.SPRITE, PIXI.Graphics.call(this), c.Component.Core.init.call(this, a, b, d, "", null)
    ...
    for (var d = 0, e = 0, f = -1, g = null, h = this._maxWidth > 0 ? this._maxWidth : null, i = [], j = 0; j < c.length; j++) {
      ...
      if (/(?:\r\n|\r|\n)/.test(c.charAt(j)))return {width: e, text: c.substr(0, j), end: k, chars: i};
    ...
    return {width: e, text: c, end: k, chars: i}
  ...
  return c.Math.degToRad = function (a) {
    ...
    spriteSheet: function (a, b, d, e, f, g, h) {
      ...
      for (var e, f = new c.FrameData, g = b.tileheight, h = b.tilewidth, i = b.layers[0].tiles, j = 0; j < i.length; j++)e = f.addFrame(new c.Frame(j, i[j].x, i[j].y, h, g, "frame_" + j)),
        e.setTrim(!1);
      return f
    ...
    soundHasUnlocked: function (a) {
      ...
      if (this._sound && this.isPlaying && !this.allowMultiple && (this.override || e))if (this.usingWebAudio)if (this.externalNode ? this._sound.disconnect(this.externalNode) : this._sound.disconnect(this.gainNode), void 0 === this._sound.stop)this._sound.noteOff(0); else try {
        this._sound.stop(0)
      } catch (f) {
      ...
      } else b = b || 0, void 0 === c && (c = this._volume), void 0 === d && (d = this.loop), this.position = b, this.volume = c, this.loop = d, this.duration = 0, this.durationMS = 0, this._tempMarker = a, this._tempPosition = b, this._tempVolume = c, this._tempLoop = d;
      ...
      if (this.isPlaying && this._sound)if (this.usingWebAudio)if (this.externalNode ? this._sound.disconnect(this.externalNode) : this._sound.disconnect(this.gainNode), void 0 === this._sound.stop)this._sound.noteOff(0); else try {
        this._sound.stop(0)
      } catch (a) {
      } else this.usingAudioTag && (this._sound.pause(), this._sound.currentTime = 0);
    ...
    packPixel: function (a, b, d, e) {
      ...
      return b || (b = c.Color.createColor()), b.r = (4278190080 & a) >>> 24, b.g = (16711680 & a) >>> 16, b.b = (65280 & a) >>> 8, b.a = 255 & a, b.rgba = "rgba(" + b.r + "," + b.g + "," + b.b + "," + b.a + ")",
        b
    ...
    TILE_BIAS: 16, collideSpriteVsTilemapLayer: function (a, b, c, d, e, f) {
      if (a.body) {
        ...
        if (0 !== g.length)for (var h = 0; h < g.length; h++)d ? d.call(e, a, g[h]) && this.separateTile(h, a.body, g[h], f) && (this._total++, c && c.call(e, a, g[h])) : this.separateTile(h, a.body, g[h], f) && (this._total++, c && c.call(e, a, g[h]))
      }
    ...
    removeBodyNextStep: function (a) {
      ...
      void 0 === a && (b = this.boundsCollisionGroup.mask), this.walls.left && (this.walls.left.shapes[0].collisionGroup = b), this.walls.right && (this.walls.right.shapes[0].collisionGroup = b), this.walls.top && (this.walls.top.shapes[0].collisionGroup = b), this.walls.bottom && (this.walls.bottom.shapes[0].collisionGroup = b)
    }, setBounds: function (a, b, c, d, e, f, g, h, i) {
      void 0 === e && (e = this._boundsLeft), void 0 === f && (f = this._boundsRight), void 0 === g && (g = this._boundsTop), void 0 === h && (h = this._boundsBottom), void 0 === i && (i = this._boundsOwnGroup), this.walls.left && this.world.removeBody(this.walls.left), this.walls.right && this.world.removeBody(this.walls.right), this.walls.top && this.world.removeBody(this.walls.top), this.walls.bottom && this.world.removeBody(this.walls.bottom), e && (this.walls.left = new p2.Body({
        mass: 0,
    ...
    get: function () {
      ...
      a && this.data.type !== c.Physics.P2.Body.DYNAMIC ? (this.data.type = c.Physics.P2.Body.DYNAMIC,
        this.mass = 1) : a || this.data.type !== c.Physics.P2.Body.DYNAMIC || (this.data.type = c.Physics.P2.Body.STATIC, this.mass = 0)
    }
    ...
    create: function (a, b, c, d, e, f) {
      ...
      if (null === j && this.format === c.Tilemap.TILED_JSON)return console.warn('Phaser.Tilemap.addTilesetImage: No data found in the JSON matching the tileset name: "' + b + '"'), null;
    ...
    INSERT_NULL: !1, parse: function (a, b, d, e, f, g) {
      ...
      for (var e = [], f = 0; f < a.layers.length; f++)if ("tilelayer" === a.layers[f].type) {
        ...
        if (!g.compression && g.encoding && "base64" === g.encoding) {
          for (var h = window.atob(g.data), i = h.length, j = new Array(i), f = 0; i > f; f += 4)j[f / 4] = (h.charCodeAt(f) | h.charCodeAt(f + 1) << 8 | h.charCodeAt(f + 2) << 16 | h.charCodeAt(f + 3) << 24) >>> 0;
          g.data = j
        }
        var k = {
          name: g.name,
        ...
        g.properties && (k.properties = g.properties);
        for (var l, m, n, o, p = 0, q = [], r = [], s = 0, i = g.data.length; i > s; s++) {
          if (l = 0, m = !1, o = g.data[s], o > 536870912)switch (n = 0, o > 2147483648 && (o -= 2147483648, n += 4), o > 1073741824 && (o -= 1073741824, n += 2), o > 536870912 && (o -= 536870912, n += 1), n) {
            case 5:
              l = Math.PI / 2;
              break;
            case 6:
          ...
          o > 0 ? (q.push(new c.Tile(k, o, p, r.length, a.tilewidth, a.tileheight)), q[q.length - 1].rotation = l, q[q.length - 1].flipped = m) : c.TilemapParser.INSERT_NULL ? q.push(null) : q.push(new c.Tile(k, -1, p, r.length, a.tilewidth, a.tileheight)), p++, p === g.width && (r.push(q), p = 0, q = [])
        }
        k.data = r, e.push(k)
      }
      d.layers = e;
      for (var t = [], f = 0; f < a.layers.length; f++)if ("imagelayer" === a.layers[f].type) {
        var u = a.layers[f], v = {
          name: u.name,
          image: u.image,
          x: u.x,
        ...
        u.properties && (v.properties = u.properties), t.push(v)
      }
      d.images = t;
      for (var w = [], x = [], f = 0; f < a.tilesets.length; f++) {
        var y = a.tilesets[f];
        if (y.image) {
          var z = new c.Tileset(y.name, y.firstgid, y.tilewidth, y.tileheight, y.margin, y.spacing, y.properties);
          y.tileproperties && (z.tileProperties = y.tileproperties), z.updateTileData(y.imagewidth, y.imageheight), w.push(z)
        } else {
          var A = new c.ImageCollection(y.name, y.firstgid, y.tilewidth, y.tileheight, y.margin, y.spacing, y.properties);
          for (var f in y.tiles) {
            var v = y.tiles[f].image, o = y.firstgid + parseInt(f, 10);
            A.addImage(o, v)
          }
          x.push(A)
        }
      }
      d.tilesets = w, d.imagecollections = x;
      for (var B = {}, C = {}, f = 0; f < a.layers.length; f++)if ("objectgroup" === a.layers[f].type) {
        var D = a.layers[f];
        B[D.name] = [], C[D.name] = [];
        for (var E = 0, i = D.objects.length; i > E; E++)if (D.objects[E].gid) {
          var F = {
            gid: D.objects[E].gid,
            name: D.objects[E].name,
            type: D.objects[E].hasOwnProperty("type") ? D.objects[E].type : "",
            x: D.objects[E].x,
            y: D.objects[E].y,
            visible: D.objects[E].visible,
            properties: D.objects[E].properties
          };
          D.objects[E].rotation && (F.rotation = D.objects[E].rotation), B[D.name].push(F)
        } else if (D.objects[E].polyline) {
          var F = {
            name: D.objects[E].name,
            type: D.objects[E].type,
            x: D.objects[E].x,
            y: D.objects[E].y,
            width: D.objects[E].width,
            height: D.objects[E].height,
            visible: D.objects[E].visible,
            properties: D.objects[E].properties
          };
          D.objects[E].rotation && (F.rotation = D.objects[E].rotation), F.polyline = [];
          for (var G = 0; G < D.objects[E].polyline.length; G++)F.polyline.push([D.objects[E].polyline[G].x, D.objects[E].polyline[G].y]);
          C[D.name].push(F), B[D.name].push(F)
        } else if (D.objects[E].polygon) {
          var F = b(D.objects[E], ["name", "type", "x", "y", "visible", "rotation", "properties"]);
          F.polygon = [];
          for (var G = 0; G < D.objects[E].polygon.length; G++)F.polygon.push([D.objects[E].polygon[G].x, D.objects[E].polygon[G].y]);
          B[D.name].push(F)
        } else if (D.objects[E].ellipse) {
          var F = b(D.objects[E], ["name", "type", "ellipse", "x", "y", "width", "height", "visible", "rotation", "properties"]);
          B[D.name].push(F)
        } else {
          var F = b(D.objects[E], ["name", "type", "x", "y", "width", "height", "visible", "rotation", "properties"]);
          F.rectangle = !0, B[D.name].push(F)
        }
      }
      d.objects = B, d.collision = C, d.tiles = [];
      for (var f = 0; f < d.tilesets.length; f++)for (var y = d.tilesets[f], p = y.tileMargin, H = y.tileMargin, I = 0, J = 0, K = 0, s = y.firstgid; s < y.firstgid + y.total && (d.tiles[s] = [p, H, f], p += y.tileWidth + y.tileSpacing, I++, I !== y.total) && (J++, J !== y.columns || (p = y.tileMargin, H += y.tileHeight + y.tileSpacing, J = 0, K++, K !== y.rows)); s++);
      for (var k, L, M, y, f = 0; f < d.layers.length; f++) {
        k = d.layers[f];
        for (var N = 0; N < k.data.length; N++) {
          q = k.data[N];
          for (var O = 0; O < q.length; O++)L = q[O], null === L || L.index < 0 || (M = d.tiles[L.index][2], y = d.tilesets[M], y.tileProperties && y.tileProperties[L.index - y.firstgid] && (L.properties = c.Utils.mixin(y.tileProperties[L.index - y.firstgid], L.properties)))
        }
      }
      return d
    }
    ...
    (void 0 === c || 0 === c) && (c = 1), void 0 === d && (d = -1), void 0 === e && (e = !0), c > this.maxParticles && (c = this.maxParticles), this._counter = 0, this._flowQuantity = c, this._flowTotal = d, e ? (this.start(!0, a, b, c), this._counter += c, this.on = !0, this._timer = this.game.time.time + b * this.game.time.slowMotion) : this.start(!1, a, b, c)
    ...
    connectToMediaStream: function (a, b) {
      ...
      return void 0 === a && (a = !1), void 0 === b && (b = 1), void 0 === c && (c = null),
        null === this.snapshot ? void console.warn("Video.grab cannot run because Phaser.BitmapData is unavailable") : (a && this.snapshot.cls(), this.snapshot.copy(this.video, 0, 0, this.width, this.height, 0, 0, this.width, this.height, 0, 0, 0, 1, 1, b, c), this.snapshot)
